...
<!-- course 1 -->
		...
		if ( $_SESSION['sess_userrole'] == "Student")// open 1st if statement
		{
						...
						if (($_SESSION['sess_cid3'])== "1" )// open 2nd if statement
							...
							else if (($_SESSION['sess_cid3'])== "2" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid3'])== "3" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid3'])== "4" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid3'])== "5" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid3'])== "6" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid3'])== "7" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid3'])== "8" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid3'])== "9" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid3'])== "10" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid3'])== "12" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid3'])== "13" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid3'])== "14" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid3'])== "15" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
