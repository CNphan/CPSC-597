...
<!-- course 1 -->
		...
		if ( $_SESSION['sess_userrole'] == "Student")// open 1st if statement
		{
						...
						if (($_SESSION['sess_cid'])== "1" )// open 2nd if statement
							{$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
											}
							...
							else if (($_SESSION['sess_cid'])== "2" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid'])== "3" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid'])== "4" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid'])== "5" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid'])== "6" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid'])== "7" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid'])== "8" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid'])== "9" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid'])== "10" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid'])== "12" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid'])== "13" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid'])== "14" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid'])== "15" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
