...
if ( $_SESSION['sess_userrole'] == "Teacher") // open first if statement
		{
						if (($_SESSION['sess_cid4'])== "1" ) // open second if statement
							{
						...
						echo "
								...
								<br></br>";
							echo "<form action=teacher_course4.php method=post>";
