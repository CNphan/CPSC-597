...
<!-- course 1 -->
		...
		if ( $_SESSION['sess_userrole'] == "Student")// open 1st if statement
		{
						...
						if (($_SESSION['sess_cid4'])== "1" )// open 2nd if statement
							{$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
											}
							...
							else if (($_SESSION['sess_cid4'])== "2" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid4'])== "3" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid4'])== "4" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid4'])== "5" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid4'])== "6" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid4'])== "7" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid4'])== "8" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid4'])== "9" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid4'])== "10" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid4'])== "12" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid4'])== "13" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid4'])== "14" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
							...
							else if (($_SESSION['sess_cid4'])== "15" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
