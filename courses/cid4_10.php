...
// Query out each course 
	...
	$c10 = mysql_fetch_array($course1);
?>

<?php

		$sql = "SELECT * FROM users WHERE cid4 = 10";
		...
		echo "<tr>";
					...
					if ((($_SESSION['sess_cid4'])== "10" ) && ($record['role'] == "Student"))
					{echo "<td>".$c10['course_name']."</td>";}
					else "<td style ='display:none !important'></td>";
					
		
			echo "<form action=teacher_grades4.php method=post>";
			...
			echo "</div>";
				...
				if ($record['role'] == "Student")
					{
						echo  "<td>" . "<input class = 'form-control' type=text name=C4hw value=" . $record['c4hw'] . " </td>";
					}
					else 
					{
			...
			echo "<form action=teacher_grades4.php method=post>";
				...
				if ($record['role'] == "Student")
					{
						echo  "<td>" . "<input class = 'form-control' type=text name=C4exam value=" . $record['c4exam'] . " </td>";
					}
					else 
					{
			...
			echo "<form action=teacher_grades4.php method=post>";
				...
				if ($record['role'] == "Student")
					{
						echo  "<td>" . "<input class = 'form-control' type=text name=C4proj value=" . $record['c4proj'] . " </td>";
					}
					else 
					{
			...
			echo "<form action=teacher_grades4.php method=post>";
				...
				if ($record['role'] == "Student")
					{
						echo  "<td>" . "<input class = 'form-control' type=text name=C4part value=" . $record['c4part'] . " </td>";
					}
					else 
					{
			...
			echo "<form action=teacher_grades4.php method=post>";
				...
				if ($record['role'] == "Student")
					{
						echo  "<td>" . "<input class = 'form-control' type=text name=C4final value=" . $record['c4final'] . " </td>";
					}
					else 
					{
