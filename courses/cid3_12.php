...
// Query out each course 
	// course 12
	$course1 = mysql_query ("SELECT * FROM course WHERE course_id = 12");
	if (!$course12)
	{
...
<?php
		...
		$sql = "SELECT * FROM users WHERE cid3 = 12";
		...
		echo "<tr>";
					...
					if ((($_SESSION['sess_cid3'])== "12" ) && ($record['role'] == "Student"))
					{echo "<td>".$c12['course_name']."</td>";}
					else "<td style ='display:none !important'></td>";
					
		
			echo "<form action=teacher_grades3.php method=post>";
			...
			echo "</div>";
				...
				echo "<div class = 'form-group'>";
						if ($record['role'] == "Student")
					{
						echo  "<td>" . "<input class = 'form-control' type=text name=C3hw value=" . $record['c3hw'] . " </td>";
					}
					else 
					{
			...
			echo "<form action=teacher_grades3.php method=post>";
				echo "<div class = 'form-group'>";
					if ($record['role'] == "Student")
					{
						echo  "<td>" . "<input class = 'form-control' type=text name=C3exam value=" . $record['c3exam'] . " </td>";
					}
					else 
					{
			...
			echo "<form action=teacher_grades3.php method=post>";
				...
				if ($record['role'] == "Student")
					{
						echo  "<td>" . "<input class = 'form-control' type=text name=C3proj value=" . $record['c3proj'] . " </td>";
					}
					else 
					{
			...
			echo "<form action=teacher_grades3.php method=post>";
				...
				if ($record['role'] == "Student")
					{
						echo  "<td>" . "<input class = 'form-control' type=text name=C3part value=" . $record['c3part'] . " </td>";
					}
					else 
					{
			...
			echo "<form action=teacher_grades3.php method=post>";
				...
				if ($record['role'] == "Student")
					{
						echo  "<td>" . "<input class = 'form-control' type=text name=C3final value=" . $record['c3final'] . " </td>";
					}
					else 
					{
