...
// Query out each course 
	// course 6
	$course1 = mysql_query ("SELECT * FROM course WHERE course_id = 6");
	if (!$course6)
	{
...
<?php
		...
		$sql = "SELECT * FROM users WHERE cid2 = 6";
		...
		echo "<tr>";
					...
					if ((($_SESSION['sess_cid2'])== "6" ) && ($record['role'] == "Student"))
					{echo "<td>".$c6['course_name']."</td>";}
					else "<td style ='display:none !important'></td>";
					
		
			echo "<form action=teacher_grades2.php method=post>";
			...
			echo "</div>";
				...
				echo "<div class = 'form-group'>";
					if ($record['role'] == "Student")
					{
						echo  "<td>" . "<input class = 'form-control' type=text name=C2hw value=" . $record['c2hw'] . " </td>";
					}
					else 
					{
			...
			echo "<form action=teacher_grades2.php method=post>";
				echo "<div class = 'form-group'>";
					if ($record['role'] == "Student")
					{
						echo  "<td>" . "<input class = 'form-control' type=text name=C2exam value=" . $record['c2exam'] . " </td>";
					}
					else 
					{
			...
			echo "<form action=teacher_grades2.php method=post>";
				echo "<div class = 'form-group'>";
					if ($record['role'] == "Student")
					{
						echo  "<td>" . "<input class = 'form-control' type=text name=C2proj value=" . $record['c2proj'] . " </td>";
					}
					else 
					{
			...
			echo "<form action=teacher_grades2.php method=post>";
				...
				if ($record['role'] == "Student")
					{
						echo  "<td>" . "<input class = 'form-control' type=text name=C2part value=" . $record['c2part'] . " </td>";
					}
					else 
					{
			...
			echo "<form action=teacher_grades2.php method=post>";
				echo "<div class = 'form-group'>";
					if ($record['role'] == "Student")
					{
						echo  "<td>" . "<input class = 'form-control' type=text name=C2final value=" . $record['c2final'] . " </td>";
					}
					else 
					{
