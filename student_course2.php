...
<!-- course 1 -->
		...
		if ( $_SESSION['sess_userrole'] == "Student")// open 1st if statement
		{
						...
						if (($_SESSION['sess_cid2'])== "1" )// open 2nd if statement
							{$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
											}
								...
								$sql = "SELECT course_name,top1,top2,top3,top4 FROM course WHERE course_id =1";
								$result = mysql_query($sql,$con);
								
									// output data for each row
									$row = mysql_fetch_array($result);
									echo "<div class = 'jumbotron'>
											<h1><center>".$row['course_name']."</center></h1></div>";
									
									// start table 
									echo "<div class = 'table-responsive'>";
									echo "<table class = 'table borderless table-striped table-hover'>";
										echo "<tr>";
										echo "<td>".$row['top1']."</td>";
										echo "</tr>";
										echo "<tr>";
							...
							}// close 2nd if statement to start else if statement
							else if (($_SESSION['sess_cid2'])== "2" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
								...
								$sql = "SELECT course_name,top1,top2,top3,top4 FROM course WHERE course_id = 2";
								$result = mysql_query($sql,$con);
							...
							else if (($_SESSION['sess_cid2'])== "3" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
								...
								$sql = "SELECT course_name,top1,top2,top3,top4 FROM course WHERE course_id = 3";
								$result = mysql_query($sql,$con);
							...
							else if (($_SESSION['sess_cid2'])== "4" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
								...
								$sql = "SELECT course_name,top1,top2,top3,top4 FROM course WHERE course_id = 4";
								$result = mysql_query($sql,$con);
							...
							else if (($_SESSION['sess_cid2'])== "5" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
								...
								$sql = "SELECT course_name,top1,top2,top3,top4 FROM course WHERE course_id = 5";
								$result = mysql_query($sql,$con);
							...
							else if (($_SESSION['sess_cid2'])== "6" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
								...
								$sql = "SELECT course_name,top1,top2,top3,top4 FROM course WHERE course_id = 6";
								$result = mysql_query($sql,$con);
							...
							else if (($_SESSION['sess_cid2'])== "7" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
								...
								$sql = "SELECT course_name,top1,top2,top3,top4 FROM course WHERE course_id = 7";
								$result = mysql_query($sql,$con);
							...
							else if (($_SESSION['sess_cid2'])== "8" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
								...
								$sql = "SELECT course_name,top1,top2,top3,top4 FROM course WHERE course_id = 8";
								$result = mysql_query($sql,$con);
							...
							else if (($_SESSION['sess_cid2'])== "9" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
								...
								$sql = "SELECT course_name,top1,top2,top3,top4 FROM course WHERE course_id = 9";
								$result = mysql_query($sql,$con);
							...
							else if (($_SESSION['sess_cid2'])== "10" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
								...
								$sql = "SELECT course_name,top1,top2,top3,top4 FROM course WHERE course_id = 10";
								$result = mysql_query($sql,$con);
							...
							else if (($_SESSION['sess_cid2'])== "12" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
								...
								$sql = "SELECT course_name,top1,top2,top3,top4 FROM course WHERE course_id =11";
								$result = mysql_query($sql,$con);
							...
							else if (($_SESSION['sess_cid2'])== "13" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
								...
								$sql = "SELECT course_name,top1,top2,top3,top4 FROM course WHERE course_id = 13";
								$result = mysql_query($sql,$con);
							...
							else if (($_SESSION['sess_cid2'])== "14" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
								...
								$sql = "SELECT course_name,top1,top2,top3,top4 FROM course WHERE course_id = 14";
								$result = mysql_query($sql,$con);
							...
							else if (($_SESSION['sess_cid2'])== "15" )// open 2nd if statement
							{
								$con = mysql_connect("localhost","root","");
								if (!$con){
									die("Can not connect: " . mysql_error());
								...
								$sql = "SELECT course_name,top1,top2,top3,top4 FROM course WHERE course_id = 15";
								$result = mysql_query($sql,$con);
		...
		}// close 1st if statement to open else 
		else 
		{
			echo "<center><h1>You cannot view the content within this page</h1></center>";
		}
						?>	
		</ul>
		</div>
